...
ActiveRecord::Schema.define(version: 20170907054240) do
  ...
  create_table "educourses", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "courseCode"
    t.string "courseName"
    t.integer "quizID"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "Educourse_id"
